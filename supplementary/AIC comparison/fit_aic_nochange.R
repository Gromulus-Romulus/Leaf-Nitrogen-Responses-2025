...
recip_nitrogen_models <- lapply(traits_of_interest,
                                function(trait)
                                  fit_mixed_models(recip_traits, trait, "treatment_mmol",
                                                   species_list,
                                                   plot_visreg = TRUE,
                                                   plot_dir = "./visreg_plots/recip_nitrogen")) |> bind_rows()

recip_nitrogen_models$Formula <- "1/trait ~ nitrogen"
...
recip_sqrt_nitrogen_models <- lapply(traits_of_interest,
                                     function(trait)
                                       fit_mixed_models(recip_sqrt_traits, trait, "treatment_mmol",
                                                        species_list,
                                                        plot_visreg = TRUE,
                                                        plot_dir = "./visreg_plots/recip_sqrt_nitrogen"
                                                        )) |> bind_rows()

recip_sqrt_nitrogen_models$Formula <- "1/sqrt(trait) ~ nitrogen"
