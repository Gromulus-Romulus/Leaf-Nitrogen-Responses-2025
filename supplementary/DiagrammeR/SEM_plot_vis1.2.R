## Visualize Final SEM Model 1.2 (Automated Version)
...
mod1.2 <- sem1.2  # Ensure this is defined earlier in your workflow
mod <- sem1.2
...
svg_filename <- paste0("SEM_Model_", "sem1.2", ".svg")
png_filename <- paste0("SEM_Model_", "sem1.2", ".png")
